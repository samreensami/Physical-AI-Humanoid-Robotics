    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https://github.com/samreensami',
        },
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/samreensami',
          label: 'GitHub',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            {
              label: 'samreensami GitHub',
              href: 'https://github.com/samreensami',
            },
            {
              label: 'LinkedIn',
              href: 'https://www.linkedin.com/in/samreen-sami-002072327',
            },
          ],
        },
        {
